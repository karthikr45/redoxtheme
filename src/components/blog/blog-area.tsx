...
import blogSection from "@/data/content/blog-section.json";
            ...
            <div className="section-title-wrapper">
              <div className="title-wrapper">
                <h2 className="section-title font-sequelsans-romanbody rr_title_anim">
                  <EditableText section="blog-section" field="heading" as="span">
                    {blogSection.heading}
                  </EditableText>{" "}
                  <span className="mb-14">
                    <EditableLink section="blog-section" field="buttonLink" currentHref={blogSection.buttonLink}>
                      <Link href={blogSection.buttonLink} className="rr-btn-group">
                        <span className="b">
                          <EditableText section="blog-section" field="buttonLabel" as="span">
                            {blogSection.buttonLabel}
                          </EditableText>
                        </span>
                        <span className="c">
