  ...
  components: {
    ...
    Works: {
      ...
      fields: {
        ...
        item1Image: { type: "text", label: "Item 1 - Image Path" },
        ...
        item2Image: { type: "text", label: "Item 2 - Image Path" },
        ...
        item3Image: { type: "text", label: "Item 3 - Image Path" },
        ...
        item4Image: { type: "text", label: "Item 4 - Image Path" },
        ...
        item5Image: { type: "text", label: "Item 5 - Image Path" },
        ...
        item6Image: { type: "text", label: "Item 6 - Image Path" },
    ...
    About: {
      ...
      fields: {
        ...
        image: { type: "text", label: "Image Path" },
      },
      defaultProps: {
        subtitle: "The studio",
    ...
    Services: {
      ...
      fields: {
        ...
        svc1Image: { type: "text", label: "Service 1 - Image Path" },
        ...
        svc2Image: { type: "text", label: "Service 2 - Image Path" },
        ...
        svc3Image: { type: "text", label: "Service 3 - Image Path" },
        ...
        svc4Image: { type: "text", label: "Service 4 - Image Path" },
        ...
        svc5Image: { type: "text", label: "Service 5 - Image Path" },
